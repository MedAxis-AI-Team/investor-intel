...
| New or changed config/env vars | `README.md` (Configuration section), `.env.example`, `CLAUDE.md` if it affects architecture |
...
- `.claude/commands/` — Slash commands: `adr`, `decision`, `git-log`, `status`
